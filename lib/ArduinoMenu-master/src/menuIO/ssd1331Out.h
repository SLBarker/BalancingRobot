...
***/
#ifndef RSITE_ARDUINOP_MENU_SSD1331
	#define RSITE_ARDUINOP_MENU_SSD1331
...
namespace Menu {
	  ...
	  class ssd1331Out:public gfxOut {
	    public:
				SSD_13XX& gfx;
				const colorDef<uint16_t> (&colors)[nColors];
		    ssd1331Out(SSD_13XX& gfx,const colorDef<uint16_t> (&c)[nColors],idx_t* t,panelsList &p,idx_t resX=6,idx_t resY=9)
