...
#define SSD1331_OUT(...) ON(SSD1331_OUT,__COUNTER__,__VA_ARGS__)
...
#define VAR_SSD1331_OUT(id,md,n,gfx,color,fontW,fontH,...)\
Menu::idx_t id##Tops##n[md];\
PANELS(id##Panels##n,__VA_ARGS__);\
Menu::ssd1331Out id##n(gfx,color,id##Tops##n,id##Panels##n,fontW,fontH);
...
#define REF_SSD1331_OUT(id,md,n,...) &id##n,
